...
# --- Descompacta dados grandes na primeira execucao (deploy prep) ---
# O repositorio carrega este arquivo comprimido em vez do cru porque o
# upload pela interface web do GitHub trava acima de ~25 MB. Descompacta
# uma unica vez, no primeiro boot do container do Streamlit Cloud (ou
# localmente, se o arquivo ainda nao existir) — depois disso o arquivo
# fica em disco e as proximas cargas usam ele direto.
import gzip
import shutil
...
from src.ui.theme import POLO, forcar_tema_polo, streamlit_css
...
# Tema Polo forcado por codigo, independente de .streamlit/config.toml —
# sem isto, um deploy em que o config.toml nao subiu (upload manual engole
# pastas ocultas) segue o modo escuro do navegador do visitante: tabela
# preta, inputs escuros, widgets vermelhos. Ver docstring em theme.py.
forcar_tema_polo()
